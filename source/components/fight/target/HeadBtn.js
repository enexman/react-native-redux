...
class BodyBtn extends React.Component {
  ...
  onPressTouchable() {
    ...
    this.props.setTargetAttack('head');
  }
  render() {
    ...
    return (
      ...
      >
        <View style={[
          ...
          (heroAttack.target === 'head') && styles.opacity,
        ]}>
          <Text style={[
            styles.text,
            theme.color,
            monster.health.head && styles.redText,
          ]}>
            Голова
          </Text>
          <View style={[
            ...
            (heroAttack.target === 'head') && theme.backgroundColor,
            monster.health.head && styles.redBorder,
          ]}></View>
          <View style={[
            styles.line,
            theme.backgroundColor,
            monster.health.head && styles.redBG,
          ]}></View>
        </View>
      </TouchableWithoutFeedback>
    );
