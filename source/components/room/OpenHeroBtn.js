...
class OpenHeroBtn extends React.Component {
  state ={
    touchColor: false,
  };
  ...
  onPress() {
    this.props.changeScreen(screenNavigation.hero);
  }
    ...
    return (
      ...
      >
        <View style={[styles.button]}>
          ...
          <Image
            style={[styles.image]}
            source={require('../../image/superhero-mask.png')}
          />
        </View>
      </TouchableWithoutFeedback>
    );
...
export default connect(({theme}) => ({theme}), {changeScreen})(OpenHeroBtn);
