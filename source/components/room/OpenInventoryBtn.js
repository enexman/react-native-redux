...
class OpenInventoryBtn extends React.Component {
  state ={
    touchColor: false,
  };
  ...
  onPress() {
    this.props.changeScreen(screenNavigation.inventory);
  }
    ...
    return (
      ...
      >
        <View style={[styles.button]}>
          ...
          <Image
            style={[styles.image]}
            source={require('../../image/inventory.png')}
          />
        </View>
      </TouchableWithoutFeedback>
    );
...
export default connect(({theme}) => ({theme}), {changeScreen})(OpenInventoryBtn);
